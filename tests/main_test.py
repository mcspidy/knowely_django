...
from main import get_users_who_sent_messages_starts_with_m_or_a
from db.models import User, Chat, Message


@pytest.mark.django_db
def test_get_users_who_sent_messages_starts_with_m_or_a() -> None:
    users = [
    ...
    messages = [
        ...
        ("Mabla-bla", "2022-03-15T00:00:00", False, 1, 2),
    ...
    assert sorted([user.username for user in users]) == sorted(["hermione321", "harry123"])
